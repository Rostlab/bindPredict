...
class Protein(object):
    ...
    def calc_scores(self):
        ...
        # for SNAP2
        if os.path.isfile(self.snap_file):
        ...
        line_num = 1
        if os.path.isfile(self.cons_file):
        ...
        for r in residue_map.keys():
            ...
            if 0 < r <= self.length:
                ...
                scores = [r_map['Cum'], r2_map['Cum'], r3_map['Cum'], r1_map['Cum'], r4_map['Cum'],
                          ...
                          r4_map['Cum_Solv'],
                          r_map['Cum_Dist'], r2_map['Cum_Dist'], r3_map['Cum_Dist'], r1_map['Cum_Dist'],
                          r4_map['Cum_Dist'],
                          r_map['Cluster'], r2_map['Cluster'], r3_map['Cluster'], r1_map['Cluster'], r4_map['Cluster'],
                          r_map['Cluster_Solv'], r2_map['Cluster_Solv'], r3_map['Cluster_Solv'], r1_map['Cluster_Solv'],
                          r4_map['Cluster_Solv'],
                          r_map['Cluster_Dist'], r2_map['Cluster_Dist'], r3_map['Cluster_Dist'], r1_map['Cluster_Dist'],
                          r4_map['Cluster_Dist'],
        ...
        with open(self.dist_file) as f:
            for line in f:
                if line_num > 1:
                    ...
                    comb_pos = pos1 + "/" + pos2
                    dist = 0.0
                    if splitted[len(splitted) - 2] != "" and re.search("[a-zA-z]+",
                                                                       splitted[len(splitted) - 2]) == 'None':
